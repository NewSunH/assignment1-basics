...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.attention import MultipleHeadSelfAttention as Mhsa
...
def run_rope(
    ...
    rope = RoPE(theta=theta, d_key=d_k, max_seq_len=max_seq_len)
...
def run_gradient_clipping(
    ...
    """
    from cs336_basics.train_transformer import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.train_transformer import learning_rate_schedule
