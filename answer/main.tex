...
\begin{itemize}
      ...
      \item NoPE (RoPE disabled): \ttbreak{outputs/runs/no\_pos\_emb\_nope\_lr\_...}.
\end{itemize}
...
\textbf{Commentary:} (fill after the NoPE run finishes; expected: removing positional info hurts validation and/or makes optimization harder).
\end{problem}
...
\textbf{Runs:}
\begin{itemize}
      \item Baseline (SwiGLU): \ttbreak{outputs/runs/20260130T032122Z}.
      \item SiLU FFN (matched params): \ttbreak{outputs/runs/swiglu\_ablation\_silu\_lr\_...}.
\end{itemize}
...
\textbf{Discussion:} (fill after runs; compare stability, speed, and final validation loss).
\end{problem}
